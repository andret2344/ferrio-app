...
export function HolidayCard(props: HolidayCardProps): React.ReactElement {
	...
	return (
		<div className='bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-12 mb-6 sm:mb-8 border border-gray-100 dark:border-gray-700 hover:shadow-3xl transition-shadow duration-300'>
			<h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white wrap-break-word mb-3'>
				{props.holiday.name}
			</h2>
